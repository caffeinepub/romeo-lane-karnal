...
export class Backend implements backendInterface {
    ...
    async addContactMessage(arg0: string, arg1: string, arg2: string): Promise<bigint> {
    ...
    async addReservation(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
